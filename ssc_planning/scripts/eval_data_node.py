...
class EvalData(object):
    def __init__(self):
        ...
        if self.evaluate:
            ...
            os.makedirs(os.path.join(self.eval_directory, "voxblox_maps", "maps"))
            os.makedirs(os.path.join(self.eval_directory, "voxblox_maps", "metrics"))
    ...
    def eval_callback(self, _):
        if self.evaluate and not self.terminitating:
            ...
            self.eval_ssc_service(
                os.path.join(self.eval_directory, "ssc_maps", "maps",
                             map_name + ".ssc"))
